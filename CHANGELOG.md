...
[spec_generator_agent](https://github.com/comain/spec_generator_agent) pins **0.8.x**. [unit-test-agent](https://github.com/comain/unit-test-agent) and [cragent](https://github.com/comain/code-review-agent) stay on last **0.7.x**. Mixed pairs
