...
from agent_core.harness.opencode_runtime import auth_headers, health_path, server_password, server_username
...
class OpenCodeServer:
    ...
    def start(self):
        ...
        # When the consumer targets native OpenCode OpenAI auth, do not leak a host OPENAI_API_KEY
        ...
        for i in range(max_retries):
            ...
            try:
                ...
                response = httpx.get(
                    f"{build_base_url(self.host, self.port)}{health_path()}",
                    timeout=5.0,
